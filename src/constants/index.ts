...
export const RING_COLOR: Colors = {
    focus: {
        blue: "focus:ring-3-blue-500",
        orange: "focus:ring-3-orange-500",
        yellow: "focus:ring-3-yellow-500",
        red: "focus:ring-3-red-500",
        purple: "focus:ring-3-purple-500",
        amber: "focus:ring-3-amber-500",
        lime: "focus:ring-3-lime-500",
        green: "focus:ring-3-green-500",
        emerald: "focus:ring-3-emerald-500",
        teal: "focus:ring-3-teal-500",
        cyan: "focus:ring-3-cyan-500",
        sky: "focus:ring-3-sky-500",
        indigo: "focus:ring-3-indigo-500",
        violet: "focus:ring-3-violet-500",
        fuchsia: "focus:ring-3-fuchsia-500",
        pink: "focus:ring-3-pink-500",
        rose: "focus:ring-3-rose-500"
    },
    "second-focus": {
        blue: "focus:ring-3-blue-500/20",
        orange: "focus:ring-3-orange-500/20",
        yellow: "focus:ring-3-yellow-500/20",
        red: "focus:ring-3-red-500/20",
        purple: "focus:ring-3-purple-500/20",
        amber: "focus:ring-3-amber-500/20",
        lime: "focus:ring-3-lime-500/20",
        green: "focus:ring-3-green-500/20",
        emerald: "focus:ring-3-emerald-500/20",
        teal: "focus:ring-3-teal-500/20",
        cyan: "focus:ring-3-cyan-500/20",
        sky: "focus:ring-3-sky-500/20",
        indigo: "focus:ring-3-indigo-500/20",
        violet: "focus:ring-3-violet-500/20",
        fuchsia: "focus:ring-3-fuchsia-500/20",
        pink: "focus:ring-3-pink-500/20",
        rose: "focus:ring-3-rose-500/20"
    }
};
