...
const SecondaryButton = (props: ButtonProps) => {
    ...
    const getClassName: () => string = useCallback(() => {
        ...
        return `w-full transition-all duration-300 bg-white dark:text-gray-700 font-medium border border-gray-300 px-4 py-2 text-sm rounded-md focus:ring-[2px] focus:ring-offset-2 hover:bg-gray-50 ${ringColor}`;
    }, [primaryColor]);
